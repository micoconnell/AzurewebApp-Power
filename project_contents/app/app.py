...
# Server=tcp:supowerdatabase.database.windows.net,1433;
# Database=SUpowerFinancials;
# Uid=micoconnell;
...
def init_connection():
    ...
    # r'SERVER=tcp:supowerdatabase.database.windows.net,1433;'
    # r'DATABASE=SUpowerFinancials;'
